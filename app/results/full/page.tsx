...
const mockResults = {
  ...
  sectionScores: [
    ...
    { name: "Reading Comprehension", score: 8, percentile: 80 },
    { name: "Data Insights", score: 6, percentile: 68 },
  ],
  questionBreakdown: [
    { name: "Correct", value: 62, color: "#10b981" },
    { name: "Incorrect", value: 18, color: "#ef4444" },
    { name: "Unanswered", value: 0, color: "#d1d5db" },
  ],
  timePerSection: [
    { name: "Quant", time: 120 },
    { name: "Verbal", time: 108 },
    { name: "Reading", time: 150 },
    { name: "Data", time: 145 },
  ],
  strengthsWeaknesses: [
  ...
  recommendations: [
    ...
    "Work on time management for Reading Comprehension passages",
    ...
    <div className="container py-12">
      ...
      >
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold tracking-tight">Full-Length Test Results</h1>
        ...
        <Tabs defaultValue="overview" className="space-y-8" onValueChange={setActiveTab}>
                ...
                <Card key={index}>
                  ...
                  <CardContent>
                    ...
                    <Button asChild variant="outline" size="sm" className="w-full">
                      <Link href={`/practice/${section.name.toLowerCase().replace(" ", "-")}`}>
          ...
          <TabsContent value="timing" className="space-y-6">
            <Card>
              <CardHeader>
                <CardTitle>Time per Section</CardTitle>
                <CardDescription>Time spent on each section (in minutes)</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-[300px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={mockResults.timePerSection}>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div>
                    <h3 className="font-medium mb-2">Average Time per Section</h3>
                    <div className="text-3xl font-bold">
                      {Math.round(
                        mockResults.timePerSection.reduce((acc, curr) => acc + curr.time, 0) /
                          mockResults.timePerSection.length,
                      )}{" "}
                      minutes
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc pl-5 space-y-1">
                      <li>You spent the most time on the Reading Comprehension section</li>
                      <li>Consider practicing with timed reading passages to improve speed</li>
                      <li>Your time allocation for Quantitative was efficient</li>
                      <li>For Data Insights, try to be more selective about which information to analyze</li>
                    </ul>
                  </div>
                </div>
              </CardContent>
